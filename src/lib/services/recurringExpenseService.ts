import type { RecurringExpense, NewRecurringExpense } from 'src/types';
import { sendDbRequest } from './dbService';

const table = 'recurringExpenses';

export async function saveRecurringExpense (expense: NewRecurringExpense): Promise<RecurringExpense> {
  try {
